const translates = {
	...
	"xjzh_meiren_juese_info": "出牌阶段限一次，你可以弃置一张牌选择一名其他角色，然后执行以下规则：<li>黑色，令其弃置X张牌，否则其须交给你一个技能（X为你对其发动该技能的次数，若其未弃牌且武将牌上无技能，改为流失一点体力）；<li>红色，令其选择摸两张牌或回复一点体力，然后你执行另一项”。",
	"xjzh_meiren_xiuya": "秀雅",
	"xjzh_meiren_xiuya_info": "锁定技，你的回合外，每当你需要打出或使用一张牌时，若牌顶堆的前四张有这张牌，你获得之",
	"xjzh_meiren_shumei": "淑美",
	"xjzh_meiren_shumei_info": "当你受到伤害后，你可以展示牌堆顶x张牌，若其中的红色牌为最多，你回复一点体力（你每因此回复体力，你的技能〖绝色〗可选择目标+1），然后获得其中花色数最多的牌（x为你本局游戏发动该技能的次数，至低为1）。",
	"xjzh_meiren_ganling": "甘霖",
	"xjzh_meiren_ganling_info": "锁定技，你防止受到所有伤害且无法成为延时锦囊的目标；你的回合外，你无法失去体力上限；你防止非正常阵亡。",
	"xjzh_meiren_miaofa": "妙法",
	"xjzh_meiren_miaofa_info": "锁定技，你的准备阶段开始时，你失去一点体力并摸一张牌，然后从未上场的<span style=\"color: yellow\">〖仙家之魂〗</span>扩展武将中展示两个技能并选择获得一个技能，限定技，觉醒技，主公技等特殊技能除外。",
	"xjzh_meiren_lunzhuan": "轮转",
	"xjzh_meiren_lunzhuan_info": "锁定技，你的手牌上限始终为你的体力上限<li>每局游戏限3次，当你阵亡前，若你的体力上限不小于2，你失去一点体力上限并恢复体力至1，然后弃置判定区的所有牌并摸手牌上限张牌<li>你失去牌有35%几率摸一张牌<li>你濒死时有30%几率恢复一点体力。",
	...
	"xjzh_meiren_chunxiao_info": "锁定技，当你受到伤害后，伤害来源获得一个“春”标记；你造成伤害有25%几率获得一点体力上限并摸一张牌（对有“春”标记的目标几率翻倍并令其弃置一张牌，然后移除标记）。",
	...
	"xjzh_meiren_lingdong_info": "锁定技，场上除你之外的所有角色回复体力都会令你获得一点护甲；当你因抵挡伤害而失去护甲后，你将手牌补至体力上限。",

	//天命奇侠
	"xjzh_qixia_daxiongxiaomao": "大熊小猫",
	"xjzh_qixia_maybe": "昔日烈火",
	"xjzh_qixia_mumuxiao": "木木枭",
	"xjzh_qixia_qiuliangming": "秋凉明",
	...
	"xjzh_qixia_jibian_info": "当你受到伤害后，你从牌堆获得x张点数为y的牌(x为你与伤害来源的体力差的绝对值，至低为1，y为体力和，至多为13)，然后令其技能描述中含有[伤害]的技能替换为〖仁德〗。",
	"xjzh_qixia_tubian": "图变",
	"xjzh_qixia_tubian_info": "出牌阶段/你受到伤害后限一次，你可以输入至多5-15个字符，匹配并展示至多3个武将，你选择获得其所有技能并将武将原画切换与其一致，然后随机切换你的性别。",
	"xjzh_qixia_niandong": "念动",
	"xjzh_qixia_niandong_info": "锁定技，每当你消耗魔力，你获得1点灵感素，最多10点，当你的灵感素达到上限时，你失去所有灵感素并在当前回合结束后执行一个额外的回合。",
	"xjzh_qixia_dikang": "抵抗",
	"xjzh_qixia_dikang_info": "锁定技，你拥有魔力抵抗，且你的魔力抵抗消耗提高60%，若你因魔力抵抗完全抵消一次伤害，你获得一个没有任何效果的技能。",
	"xjzh_qixia_juneng": "聚能",
	"xjzh_qixia_juneng_info": "锁定技，你每拥有一个锁定技，你的回合结束时回复10点魔力，你每拥有一个非锁定技，你的灵感素上限减1。",
