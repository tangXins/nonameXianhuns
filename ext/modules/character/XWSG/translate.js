...
const translates = {
	...
	"xjzh_sanguo_zhangchunhua": "张春华",
	"xjzh_sanguo_caiyan": "蔡琰",
	"xjzh_sanguo_simayi": "司马懿",
	...
	"xjzh_sanguo_shangshi_info": "锁定技，当你使用牌后，若你已受伤，你摸一张牌，若此牌与你上一张使用的牌颜色不一致，你弃置一名其他角色一张牌。",
	"xjzh_sanguo_huishi": "慧识",
	"xjzh_sanguo_huishi_info": "锁定技，你令其他角色的限定技、觉醒技、主公技、使命技等特殊技能失效（有“星魂”标签的技能除外）。",
	"xjzh_sanguo_pijian": "披坚",
	"xjzh_sanguo_pijian_info": "你的准备阶段，你可以从随机3个与【杀】有关的技能中选择1个将其视为武器牌装备之，当你失去此牌时，你将手牌补至体力上限；锁定技，你获得技能时，获得一个额外的武器栏。",
	...
	"xjzh_sanguo_longhun_info": "你可以将一张手牌按照以下花色规则使用或打出：♦️当做【火杀】；♣️当做【闪】；♥️当做【桃】；♠️当做【无懈可击】",
	"xjzh_sanguo_peijian": "佩剑",
	"xjzh_sanguo_peijian_info": "锁定技，你的攻击距离无限且你使用【杀】无视防具。",
	"xjzh_sanguo_kuanggu": "狂骨",
	"xjzh_sanguo_kuanggu_info": "锁定技，你的体力值锁定为你的体力上限；你受到的所有伤害和体力流失视为失去1点体力上限；你造成伤害获得1点体力上限。",
	"xjzh_sanguo_kuangxi": "狂袭",
	"xjzh_sanguo_kuangxi_info": "你使用非延时锦囊牌指定目标结算后，你可以失去1点体力上限，视为对该卡牌目标使用一张【杀】。",
	"xjzh_sanguo_aogu": "傲骨",
	"xjzh_sanguo_aogu_info": "锁定技，当你获得体力上限时，若你的体力上限不小于8，改为摸2张牌；当你的体力上限为8时，你视为拥有技能〖咆哮〗〖武圣〗；你的手牌上限始终为5。",
	...
	"xjzh_sanguo_jiqiao_info": "锁定技，一名角色判定时或恢复体力后，你令其摸两张牌或你摸一张牌。",
	...
	"xjzh_sanguo_liegong_info": "你使用【杀】指定目标可以令此【杀】无法闪避且根据条件发动以下效果：<li>♥此【杀】额外指定x个目标(x为你手牌中的非♥牌数量，每种花色最大为1)<li>♦此【杀】攻击距离+y(y为此【杀】的点数)<li>♣此【杀】令其额外弃置z张手牌(z为你手牌中非♣牌的数量，每种花色最大为1)",
	...
	"xjzh_sanguo_xiongbin_info": "出牌阶段限一次，你可以扣置一张手牌，然后令其他角色依次展示一张手牌(无牌则跳过)，你可以视为对其中花色、点数任意一项一致的目标使用一张无次数限制且无视防具的【杀】，技能结算后，你获得其他角色展示的花色、点数均与你不同的牌。",
	...
	"xjzh_sanguo_yinren_info": "锁定技，场上每有一名角色阵亡，你你依次获得技能〖极略〗/〖奇才〗，当你因此技能获得以上两个技能时，你移除该技能，否则你防止伤害/失去体力/失去体力上限/阵亡。",
	...
	"xjzh_sanguo_biantian_info": "觉醒技，当你进行〖博略〗判定之后，你记录判定牌花色，若你记录的花色各不相同且不小于4，你获得一点体力上限，然后从牌堆中获得花色各不相同的四张牌并获得技能〖鹰视〗、〖狼顾〗，此后〖博略〗发动时不再判定，你随机获得魏蜀吴群四个势力各一个技能。",
	"xjzh_sanguo_yingshi": "鹰视",
	"xjzh_sanguo_yingshi_info": "当你受到/造成伤害后，你可以观看伤害来源/目标的手牌并获得其中一张牌。",
	"xjzh_sanguo_langgu": "狼顾",
	"xjzh_sanguo_langgu_info": "锁定技，当你不因此技能摸/获得牌时，你将其置于弃牌堆，然后从牌堆中随机获得四张花色不同的牌。",
	...
	"xjzh_sanguo_cuifeng_info": "其他角色成为【杀】和【决斗】的唯一目标时，你可以令其摸一张牌，然后你成为此卡牌的目标。",
	"xjzh_sanguo_chaohuang": "朝凰",
	"xjzh_sanguo_chaohuang_info": "限定技，出牌阶段，你可以弃置区域内所有牌，然后将手牌补至体力上限，然后在该回合内，你使用【杀】无次数和距离限制，并且你的手牌数始终不小于你的体力上限。",
	...
	"xjzh_sanguo_bujiao_info": "其他角色出牌阶段开始时，你可以交给其一张牌，若如此做，你将牌堆顶的一张牌置于武将牌上称为“教”；你获得该技能时，你将牌堆顶2两张牌置于武将牌上称为“教”。",
	"xjzh_sanguo_guidao": "诡道",
	"xjzh_sanguo_guidao_info": "若你有“教”，你可以将一张“教”将其当作任意一张对应类型的牌使用之。",
	"xjzh_sanguo_taiping": "太平",
	"xjzh_sanguo_taiping_info": "当你受到伤害时，你可以判定：黑色，你将判定牌置于武将牌上，然后摸一张牌，红色，你回复一点体力，然后若当前回合不为你，其结束当前回合。",
	"xjzh_sanguo_fangshu": "方术",
	"xjzh_sanguo_fangshu_info": "出牌阶段开始前，你展示牌堆顶x张牌，若所有颜色相同，你获得这些牌，否则：黑色更多，你对一名其他角色造成1点雷属性伤害；红色更多，你将其中两张颜色各不相同的牌置于武将牌上称为“教”（x为“教”各不相同的类型的数量，至少为1，至多为3）。",
	...
	"xjzh_sanguo_dianjie_info": "出牌阶段限一次，你可以移除6个标记并选择至多3个目标，令其受到至多3点无来源雷电伤害，你可以任意分配伤害点数，由此法造成雷属性伤害不获得“电”标记。",
	"xjzh_sanguo_hongfa": "弘法",
	"xjzh_sanguo_hongfa_info": "锁定技，当你受到及造成雷属性伤害后，获得等量个“电”标记。",
	...
	"xjzh_sanguo_shenwei_info": "锁定技，当你的体力变化后，若此时你的体力大于2，你摸两张牌，否则你将体力上限改为2，然后恢复体力至体力上限，获得技能〖鬼躯〗、〖修罗〗，技能结算后，你立即结束当前回合并执行一个额外的回合，然后你失去该技能。",
	...
	"xjzh_sanguo_shishu_info": "锁定技，每当你造成/受到1点伤害后，你观看牌堆顶2张牌，并选择获得其中一张，然后将另外一张置于武将牌上称为“书”；你的红色/黑色“书”视为【火攻】/【无懈可击】。",
	"xjzh_sanguo_wulue": "武略",
	"xjzh_sanguo_wulue_info": "出牌阶段限一次，你可以展示所有“书”，若红色牌多于黑色牌，你获得技能〖攻心〗，否则你获得〖制衡〗，然后你可以令一名其他角色视为装备【藤甲】直到回合结束。",
	...
	"xjzh_sanguo_guanxing_info": "你的准备阶段，你可以观看牌堆顶的5张牌，然后将其中任意数量的牌置于牌堆顶，将其余的牌置于牌堆底，然后根据你操作的牌获得【七星命盘】中的一个效果，并视为点亮相对应的星象。",
	"xjzh_sanguo_xinghun": "星魂",
	"xjzh_sanguo_xinghun_info": "锁定技，每当你受到一点伤害，你摸一张牌并展示此牌，然后获得一个技能描述中含有此牌牌名的技能；你每点亮【七星命盘】中的一个星象，你的手牌上限和摸牌数+1。",
	"xjzh_sanguo_wuxiang": "武乡",
	"xjzh_sanguo_wuxiang_info": "锁定技，当你濒死时，若你已点亮【七星命盘】中的所有星象，你熄灭【七星命盘】中的所有星象，然后你失去一点体力上限，然后回复体力至体力上限。",
	"xjzh_sanguo_luanzheng": "乱政",
	"xjzh_sanguo_luanzheng_info": "锁定技，游戏开始时，若你为主公，你与场上随机一名不为反贼的角色交换身份牌，若你为反贼，你将身份牌改为内奸。",
	"xjzh_sanguo_chanxian": "谗陷",
	"xjzh_sanguo_chanxian_info": "当你成为[伤害]卡牌的目标时，若你为唯一目标，你可以为其指定一名不为你和卡牌来源的额外目标，若你不为唯一目标，你可以弃置一张牌令此牌无效。",
	...
	"xjzh_sanguo_yuewu_info": "出牌阶段限一次，你选择两名其他角色，令其选择是否交给你一种花色的手牌，交给你牌的角色视为对未交给你牌的角色使用一张无法被无懈可击响应的【决斗】。",
	"xjzh_sanguo_yuehun": "月魂",
	"xjzh_sanguo_yuehun_info": "当你成为其他角色的基本牌或锦囊牌的唯一目标时，你可以视为对其使用一张同名牌。",
	...
	"xjzh_sanguo_busuan_info": "锁定技，出牌阶段限一次，你随机获得一张【春风化雨】、【翻云覆雨】、【纸醉金迷】、【昙花一现】、【神机妙算】，然后你选择从牌堆获得至多2张类型不一致的非装备牌，并将等量手牌洗入牌堆(以上五张牌不计入手牌上限且无法被弃置、获得)",
	"xjzh_sanguo_busuan_append": "注：【春风化雨】、【翻云覆雨】、【纸醉金迷】、【昙花一现】、【神机妙算】不计入手牌上限且无法被弃置、获得",
	"xjzh_sanguo_zhanji": "占箕",
	"xjzh_sanguo_zhanji_info": "锁定技，你的出牌阶段外弃置牌时、成为其他角色锦囊牌的目标时、受到伤害时，你发动一次〖卜算〗。",
	...
	"xjzh_sanguo_huchi_info": "锁定技，你因〖裸衣〗使用【杀】造成伤害后，你获得牌堆顶前3张牌中的所有防具牌和基本牌，若此时无防具牌和基本牌，你回复一点体力；你使用基本牌时可以失去一点体力令此牌伤害+1或获得一张防具牌。",
	...
	"xjzh_sanguo_zhiti_info": "锁定技，当你造成/受到伤害后，你令其获得一个“止”标记；其他角色获得/失去“止”标记时，其选择废除/恢复一个装备栏",
	"xjzh_sanguo_cuifengx": "摧锋",
	"xjzh_sanguo_cuifengx_info": "出牌阶段限一次，你可以移动场上的“止”标记，然后视为移动前的目标对移动后的目标使用1张不计入次数的【杀】,且以此法使用的【杀】造成2点伤害。",
	...
	"xjzh_sanguo_yinshi_info": "锁定技，若你的武将牌上存在“杰”，你的回合外防止所有伤害；出牌阶段限一次，若你有“杰”，你可以选择一名令其他角色并令其替换武将牌为你选择的一张“杰，然后重置武将牌。",
	...
	"xjzh_sanguo_jiang_info": "当你不因此技能受到伤害后或不因此技能指定其他角色为[伤害]卡牌的唯一目标后，你可以令伤害来源/其弃置一张牌视为使用一张你指定目标和卡牌的任意[伤害]卡牌，其使用的这张牌的伤害来源均视为你（指定目标为全部角色的牌跳过选择目标）。",
	"xjzh_sanguo_hunzi": "魂资",
	"xjzh_sanguo_hunzi_info": "锁定技，你造成的伤害均视为无属性伤害，你区域内的所有卡牌花色视为无花色，你造成伤害时/受到伤害后摸一张牌。",
	"xjzh_sanguo_guose": "国色",
	"xjzh_sanguo_guose_info": "游戏开始时，你将牌堆所有的【乐不思蜀】移出游戏；其他角色准备阶段开始时，若该回合不为〖婉容〗执行的额外回合，你可以弃置一张♦牌令其执行一次【乐不思蜀】判定。",
	"xjzh_sanguo_wanrong": "婉容",
	"xjzh_sanguo_wanrong_info": "当一名角色的【乐不思蜀】判定成功后，你可以选择一名其他角色，然后你摸两张牌并令其执行一个额外的回合。",
	"xjzh_sanguo_tianxiang": "天香",
	"xjzh_sanguo_tianxiang_info": "锁定技，当你失去手牌/装备区的♥️牌后，你可以令一名角色获得一个“天香”标记，有“天香”标记的角色区域内的♠️牌视为♥️牌。",
	"xjzh_sanguo_emei": "额眉",
	"xjzh_sanguo_emei_info": "锁定技，当一名角色获得/移去“天香”标记时，其随机获得/失去一个技能；出牌阶段限一次，你可以移去一名角色的所有“天香”标记，然后你选择一项：<br><li>令其失去所有技能<li>令其受到等量伤害<li>令其摸等量牌<li>令其获得随机获得一个技能",
	"xjzh_sanguo_lixiang": "离乡",
	"xjzh_sanguo_lixiang_info": "限定技，当你濒死时，你将武将牌替换为“小乔”或“大乔”，并回复体力至体力上限。",
	"xjzh_sanguo_dianxing": "电刑",
	"xjzh_sanguo_dianxing_info": "出牌阶段限一次，你可以弃置一张牌令一名敌方角色判定，若判定牌颜色与你弃置的牌颜色一致，你对其造成1点雷电伤害，然后你可以重复此流程（不再弃牌）。",
