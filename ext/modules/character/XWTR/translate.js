const translates = {
	...
	"xjzh_diablo_xianjing_info":"出牌阶段限一次，你可以观看牌堆随机x（x为牌堆牌的数量的百分之一并向上取整）张牌，并将其标记为“剧毒陷阱”，然后将这张牌洗入牌堆随机位置，当其他角色获得此牌时，其获得最大层数中毒。<li>会心：其他角色获得此牌时，你有20%几率摸2张牌并获得此牌；你有30%几率回复25点魔力。",
	...
	"xjzh_dnf_jianshen_info":"锁定技，场上其他角色无法使用牌名、描述中有“剑”的牌，你只能装备牌名、描述中有剑的武器牌；你的准备阶段、结束阶段，你选择并装备【魔剑·克拉丽丝】、【巨力黄金锤】、【天脊骨狱息】、【天丛云剑】、【名刀·观世正宗】",
	"xjzh_dnf_aoyi":"奥义",
	"xjzh_dnf_aoyi_info":"锁定技，你的武器栏无法废除；你切换武器牌时可以获得附近角色一张手牌，并根据你此时装备的武器牌类型获得不同效果：<li>光剑，移除你的所有控制效果；<li>巨剑，令附近随机一名敌方角色武将牌翻至背面；<li>短剑，对附近随机一名敌方角色造成一点伤害；<li>太刀，弃置所有敌方角色的武器牌；<li>钝器，令周围随机一名敌方角色陷入混乱。",
